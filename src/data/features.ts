...
export const featureData = {
  featureAvailability: {
    ...
    "Multiple iterative parallel searches": {free: false, pro: "In Sample", pro_ai: false, plus_v1: false, plus_v1_ai: true, plus_v2: true, grid_v1: false, grid_v1_ai: true, grid_v2: true},
    ...
    "Emails - search, draft, and send": {free: false, pro: false, pro_ai: false, plus_v1: false, plus_v1_ai: true, plus_v2: true, grid_v1: false, grid_v1_ai: true, grid_v2: true},
  ...
  featureDescriptions: {
    ...
    "Legal Holds": "Preserve users data for litigation purposes (even if it's deleted via Retention Settings).",
    ...
    "EMM (Enterprise Mobility Management)": "Integrates with a company's existing EMM to enforce mobile security policies like blocking access from unmanaged devices and requiring use of a managed EMM app.",
