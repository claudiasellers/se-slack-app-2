...
export const featureData = {
    featureAvailability: {
      ...
      "Channel Posting Permissions": {
        free: "(#general channel only)",
        pro: "(#general channel only)",
        plus: true,
        grid: true,
      },
      ...
      "Customer Support Tier": {
        ...
        pro: "24/7 support",
        plus: "24/7 support (4-hour first response)",
        grid: "24/7 priority support (4-hour first response)",
      },
    ...
    featureDescriptions: {
      ...
      "Custom Canvas Templates":
        "Custom Canvas Templates in Slack's Enterprise Grid allow teams to create and share standardized templates for canvases, facilitating consistent documentation and workflows across the organization",
      ...
      "Slack Connect (Shared Channels)":
        "Connect channels between separate workspaces to collaborate with external partners.",
      ...
      Elevate:
        "A single view of critical information for sales teams including metrics, opportunity list views, and notifications.",
      ...
      "Domain Claiming (create workspace)":
        "Prevent Free workspaces from being created that are linked to a claimed corporate email domain.",
      "MDM (Mobile Device Management)":
        "Apply extra security controls at the device level. Managed via AppConfig vendor apps.",
      ...
      "Customer Support Tier":
        "Enterprise Grid customers may be supported by a dedicated Account Executive and Success Guide.",
