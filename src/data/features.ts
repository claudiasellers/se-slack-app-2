...
export const featureData = {
    featureAvailability: {
      ...
      "Atlas": { free: false, pro: false, plus: "Add-on", grid: true },
      ...
      "Guaranteed Uptime and Fast Customer Support": {free: false, pro: false, plus: true, grid: true},
      "Integrations": {free: "Only 10", pro: true, plus: true, grid: true},
