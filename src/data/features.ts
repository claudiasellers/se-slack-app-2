...
export const featureData = {
  featureAvailability: {
    ...
    "Native Device Management: Block Copy / Paste": { free: true, pro: true, plus_v1: true, plus_v2: true, grid_v1: true, grid_v2: true },
  ...
  featureDescriptions: {
    ...
    "Native Device Management: Block Copy / Paste": "Prevents data leakage by disabling file downloads and restricting copy/paste from managed apps to personal ones.",
